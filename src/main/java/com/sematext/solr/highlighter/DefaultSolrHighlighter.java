/*
 * This file was coppied from Lucene/Solr and modified slightly. Original code
 * didn't allow to highlight Trie* fields. It was not possible to highlight for
 * example integer or long fields. When solr code will change in a future, and
 * will allow to highlight numeric fields, this class won't be required any more.
 */
...
public class DefaultSolrHighlighter extends SolrHighlighter implements PluginInfoInitialized {
  ...
  public void init(PluginInfo info) {
    ...
    if (enc == null) {
      enc = new org.apache.solr.highlight.DefaultEncoder();
    }
    encoders.put("", enc);
    ...
    if (fragListBuilder == null) {
      fragListBuilder = new org.apache.solr.highlight.SimpleFragListBuilder();
    }
    ...
    if (fragsBuilder == null) {
      fragsBuilder = new org.apache.solr.highlight.ScoreOrderFragmentsBuilder();
    }
    ...
    if (boundaryScanner == null) {
      boundaryScanner = new org.apache.solr.highlight.SimpleBoundaryScanner();
    }
  ...
  public void initalize(SolrConfig config) {
    ...
    SolrEncoder enc = new org.apache.solr.highlight.DefaultEncoder();
    encoders.put("", enc);
    encoders.put(null, enc);

    SolrFragListBuilder fragListBuilder = new org.apache.solr.highlight.SimpleFragListBuilder();
    fragListBuilders.put("", fragListBuilder);
    fragListBuilders.put(null, fragListBuilder);

    SolrFragmentsBuilder fragsBuilder = new org.apache.solr.highlight.ScoreOrderFragmentsBuilder();
    fragmentsBuilders.put("", fragsBuilder);
    fragmentsBuilders.put(null, fragsBuilder);

    SolrBoundaryScanner boundaryScanner = new org.apache.solr.highlight.SimpleBoundaryScanner();
    boundaryScanners.put("", boundaryScanner);
    boundaryScanners.put(null, boundaryScanner);
  }
  ...
  /**
   * Return the max number of snippets for this field. If this has not been configured for this field, fall back to the
   * configured default or the solr default.
   *
   * @param fieldName The name of the field
  ...
  /**
   * Return an {@link org.apache.lucene.search.highlight.Encoder} appropriate for this field. If an encoder has not been
   * configured for this field, fall back to the configured default or the solr default
  ...
  /**
   * Return a {@link org.apache.lucene.search.highlight.Fragmenter} appropriate for this field. If a fragmenter has not
   * been configured for this field, fall back to the configured default or the solr default ({@link GapFragmenter}).
   *
   * @param fieldName The name of the field
   * @param params The params controlling Highlighting
